...
//	TW_API int  TW_CALL TwEventCharGLFW(int glfwChar, int glfwAction);
  typedef struct GLFWwindow GLFWwindow;
	...
	///GLFW3 callbacks:
	TW_API void   TW_CDECL_CALL TwEventMouseButtonGLFW3(GLFWwindow* win, int glfwButton, int glfwAction,int modes);
	TW_API void   TW_CDECL_CALL TwEventMousePosGLFW3(GLFWwindow*    win,double mouseX, double mouseY);
	TW_API void   TW_CDECL_CALL TwEventMouseWheelGLFW3(GLFWwindow*  win,double axisX,double axisY);

	TW_API void  TW_CDECL_CALL  TwEventKeyGLFW3(GLFWwindow* win ,int glfwKey, int scanCode,int action,int modes);
	TW_API void  TW_CDECL_CALL  TwEventCharGLFW3(GLFWwindow* win,unsigned int codePoint);
