...
void CScreenQuadPass::initV()
{
	...
	std::shared_ptr<ElayGraphics::STexture> ComputeTexture =(ElayGraphics::ResourceManager::getSharedDataByName<std::shared_ptr<ElayGraphics::STexture>>("ShadingTexture"));
