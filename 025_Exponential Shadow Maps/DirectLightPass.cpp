...
void CDirectLightPass::initV()
{
	...
	auto LightDepthTexture = ElayGraphics::ResourceManager::getSharedDataByName<std::shared_ptr<ElayGraphics::STexture>>("BlurLightDepthTexture");
	...
	m_pShader->setFloatUniformValue("m_CameraSizeExtent", ElayGraphics::ResourceManager::getSharedDataByName<float>("m_CameraSizeExtent") * ElayGraphics::ResourceManager::getSharedDataByName<float>("m_CameraSizeExtent"));
	m_LightDir = ElayGraphics::ResourceManager::getSharedDataByName<glm::vec3>("LightDir");	
	auto LightColor = ElayGraphics::ResourceManager::getSharedDataByName<glm::vec3>("LightColor");	
