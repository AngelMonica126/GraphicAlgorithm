...
void CCustomGUI::initV()
{
	...
	ElayGraphics::ResourceManager::registerSharedData("NormalThreshold", m_NormalThresholdInEdgeDetecion);
	ElayGraphics::ResourceManager::registerSharedData("DepthThreshold", m_DepthThresholdInEdgeDetection);
}
