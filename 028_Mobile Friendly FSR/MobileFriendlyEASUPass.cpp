...
CMobileFriendlyEASUPass::CMobileFriendlyEASUPass(const std::string& vPassName, int vExcutionOrder) : IRenderPass(vPassName, vExcutionOrder)
{
}

CMobileFriendlyEASUPass::~CMobileFriendlyEASUPass()
{
}


void CMobileFriendlyEASUPass::fsrEasuCon(
	glm::vec4& Con0,
	glm::vec4& Con1,
	glm::vec4& Con2,
	glm::vec4& Con3,
...
void CMobileFriendlyEASUPass::initV()
{
	...
	TextureConfig4EASU->ImageBindUnit = 3;
	...
	m_pShader = std::make_shared<CShader>("MobileFriendlyEASUPass_CS.glsl");
	...
	m_pShader->setFloatUniformValue("u_InvDisplayWidth", 1.0f / m_RenderWidth);
	m_pShader->setFloatUniformValue("u_InvDisplayHeight", 1.0f / m_RenderHeight);
	...
	ElayGraphics::ResourceManager::registerSharedData("MFEASUTexture", TextureConfig4EASU);
}

void CMobileFriendlyEASUPass::updateV()
{
	m_pShader->activeShader();
