...
//	vec3 TexelColor = (texture(u_IndirectTexture, v2f_TexCoords).rgb );
	vec3 TexelColor = (texture(u_IndirectTexture, v2f_TexCoords).rgb + texture(u_DirectTexture, v2f_TexCoords).rgb) * Albedo;
